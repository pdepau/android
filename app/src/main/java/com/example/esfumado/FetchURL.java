...
public class FetchURL extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings ) {
        ...
        try {
            ...
            if(strings[1].equals("GET")){
                ...
                Log.d("PRUEBA", "Background task data " + data.toString());
            }else{
    ...
    private String downloadUrl(String strUrl) throws IOException {
        ...
        try {
            ...
            data = sb.toString();
            Log.d("PRUEBA", "Downloaded URL: " + data.toString());
            br.close();
        } catch (Exception e) {
            Log.d("PRUEBA", "Exception downloading URL: " + e.toString());
        } finally {
            //iStream.close();
    ...
    private String postUrl(String strUrl) throws IOException {
        ...
        try {
            URL url = new URL(strUrl);
            String jsonInputString = "{\"co2\": \""+valor +"\", \"fecha\": \"fecha\"}";
            // Creating an http connection to communicate with url
