 ...
 * FECHA: 17/10/2021
 * DESCRIPCION: clase para la gestion de la traba de los IBeacons con sus respectivos getters y setters
 *
 */
...
public class TramaIBeacon {
    ...
    /**
     * Constructor de TramaIBeacon, recibe un Array de byte y genera la trama propia de un IBeacon
     * @param bytes
     */
    // -------------------------------------------------------------------------------
    // -------------------------------------------------------------------------------
    ...
    /**
     *Getters y Setters del objeto TramaIBeacon
     *
     */
    // -------------------------------------------------------------------------------
    // -------------------------------------------------------------------------------
